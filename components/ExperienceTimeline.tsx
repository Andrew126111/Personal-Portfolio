    ...
    >
      <div className="relative z-10 max-w-6xl mx-auto px-8 md:px-16">
        ...
        <div className="relative">
          ...
          <div
            data-reveal="line"
            data-start="top 85%" data-end="bottom 10%"
            className="absolute left-[60px] md:left-[80px] top-0 bottom-0 w-px"
            style={{ backgroundColor: "#2b2d42", opacity: 0.1, transformOrigin: "top" }}
          />
...
function TimelineItem({ item, index }: { item: typeof timeline[0]; index: number }) {
  const startBase = 10 + index * 20;

  return (
    <div
      data-reveal="slide"
      data-start={`top ${100 - startBase}%`}
      data-end={`top ${80 - startBase}%`}
